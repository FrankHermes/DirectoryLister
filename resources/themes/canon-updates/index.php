...
<head>
    ...
    <title>Canon van Nederland installers</title>
        ...
        <?php foreach($dirArray as $name => $fileInfo): ?>
            <li data-name="<?php echo $name; ?>" data-href="<?php echo $fileInfo['url_path']; ?>">
				...
				if(isset($fileInfo['info'])) {
					...
					$json = json_decode($fileInfo['info']);

					if (isset($json->Status))
					{
						$statusClass = $json->Status;
					}
					else {
						$statusClass = "";
					}
					...
					?>
                <a href="<?php echo $fileInfo['url_path']; ?>" class="clearfix <?php echo $statusClass;?>" data-name="<?php echo $name; ?>">
